...
async function loadData(request, templateId, viewId) {
    ...
    console.log(template); // Is this a function?
    console.log(Handlebars.templates); // What templates are available?
...
async function login(e) {
    e.preventDefault();
    let username = document.getElementById('username').value; let password = document.getElementById('password').value; document.getElementById('errorMessage').innerHTML = '';
    try {
